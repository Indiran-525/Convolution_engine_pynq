...
# 
# ==============================================================
set ::env(PATH) "K:/Vivado/2025.1/Vitis/win64/tools/fpo_v7_1;$::env(PATH)"
set ::env(PATH) "K:/Vivado/2025.1/Vitis/win64/tools/fft_v9_1;$::env(PATH)"
set ::env(PATH) "K:/Vivado/2025.1/Vitis/win64/tools/fir_v7_0;$::env(PATH)"
set ::env(PATH) "K:/Vivado/2025.1/Vitis/win64/tools/dds_v6_0;$::env(PATH)"
set ::env(PATH) "K:/Vivado/2025.1/Vitis/tps/mingw/10.0.0/win64.o/nt/bin;$::env(PATH)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convbas.autotvin.dat"
	set constFileTvOut       "convbas.autotvout.dat"
	set constFileHdlTvIn     "convbas.autohdltvin.dat"
	set constFileHdlTvOut    "convbas.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
