...
AUTOPILOT_ROOT := K:/Vivado/2025.1/Vitis
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := K:/Vivado/2025.1/Vitis/tps/win64/msys64/mingw64/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := K:/Vivado/2025.1/Vitis/win64/tools/vcxx/libexec/
TOOLCHAIN += --sysroot=K:/Vivado/2025.1/Vitis/tps/mingw/10.0.0/win64.o/nt
LFLAG += --sysroot=K:/Vivado/2025.1/Vitis/tps/mingw/10.0.0/win64.o/nt
...
$(ObjDir)/convbas.cpp_pre.cpp.tb.o : convbas.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling convbas.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
