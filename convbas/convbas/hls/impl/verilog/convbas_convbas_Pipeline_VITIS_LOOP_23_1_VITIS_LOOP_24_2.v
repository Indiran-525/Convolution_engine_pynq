...
module convbas_convbas_Pipeline_VITIS_LOOP_23_1_VITIS_LOOP_24_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] select_ln23_fu_155_p3;
reg   [1:0] select_ln23_reg_247;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
wire   [1:0] select_ln23_1_fu_163_p3;
reg   [1:0] select_ln23_1_reg_252;
reg   [15:0] gmem2_addr_read_reg_258;
wire   [63:0] zext_ln25_2_fu_212_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [1:0] j_fu_56;
wire   [1:0] add_ln24_fu_171_p2;
wire    ap_loop_init;
reg   [1:0] i_fu_60;
reg   [3:0] indvar_flatten_fu_64;
wire   [3:0] add_ln23_1_fu_120_p2;
reg   [3:0] ap_sig_allocacmp_indvar_flatten_load;
wire    ap_block_pp0_stage0;
reg    local_kernel_we0_local;
reg    local_kernel_ce0_local;
wire   [0:0] icmp_ln24_fu_149_p2;
wire   [1:0] add_ln23_fu_143_p2;
wire   [3:0] p_shl_fu_190_p3;
wire   [3:0] zext_ln25_fu_187_p1;
wire   [3:0] sub_ln25_fu_197_p2;
wire   [3:0] zext_ln25_1_fu_203_p1;
wire   [3:0] add_ln25_fu_206_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln23_fu_114_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln23_fu_114_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        local_kernel_we0_local = 1'b1;
    end else begin
        local_kernel_we0_local = 1'b0;
    end
end
...
assign add_ln23_1_fu_120_p2 = (ap_sig_allocacmp_indvar_flatten_load + 4'd1);

assign add_ln23_fu_143_p2 = (i_fu_60 + 2'd1);

assign add_ln24_fu_171_p2 = (select_ln23_fu_155_p3 + 2'd1);

assign add_ln25_fu_206_p2 = (sub_ln25_fu_197_p2 + zext_ln25_1_fu_203_p1);
...
assign icmp_ln23_fu_114_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln24_fu_149_p2 = ((j_fu_56 == 2'd3) ? 1'b1 : 1'b0);

assign local_kernel_address0 = zext_ln25_2_fu_212_p1;

assign local_kernel_ce0 = local_kernel_ce0_local;

assign local_kernel_d0 = gmem2_addr_read_reg_258;

assign local_kernel_we0 = local_kernel_we0_local;
...
assign p_shl_fu_190_p3 = {{select_ln23_1_reg_252}, {2'd0}};

assign select_ln23_1_fu_163_p3 = ((icmp_ln24_fu_149_p2[0:0] == 1'b1) ? add_ln23_fu_143_p2 : i_fu_60);

assign select_ln23_fu_155_p3 = ((icmp_ln24_fu_149_p2[0:0] == 1'b1) ? 2'd0 : j_fu_56);

assign sub_ln25_fu_197_p2 = (p_shl_fu_190_p3 - zext_ln25_fu_187_p1);

assign zext_ln25_1_fu_203_p1 = select_ln23_reg_247;

assign zext_ln25_2_fu_212_p1 = add_ln25_fu_206_p2;

assign zext_ln25_fu_187_p1 = select_ln23_1_reg_252;

endmodule //convbas_convbas_Pipeline_VITIS_LOOP_23_1_VITIS_LOOP_24_2
