...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename local_kernel \
    op interface \
    ports { local_kernel_address0 { O 4 vector } local_kernel_ce0 { O 1 bit } local_kernel_we0 { O 1 bit } local_kernel_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_kernel'"
}
}
