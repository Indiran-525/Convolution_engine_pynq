set moduleName convbas_Pipeline_VITIS_LOOP_23_1_VITIS_LOOP_24_2
set isTopModule 0
...
set cdfgNum 5
set C_modelName {convbas_Pipeline_VITIS_LOOP_23_1_VITIS_LOOP_24_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_kernel { MEM_WIDTH 16 MEM_SIZE 18 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem2 int 16 regular {axi_master 0}  }
	{ sext_ln23 int 63 regular  }
	{ local_kernel int 16 regular {array 9 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "w_kernel","offset": { "type": "dynamic","port_name": "w_kernel","bundle": "CTRL"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "local_kernel", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ local_kernel_address0 sc_out sc_lv 4 signal 2 } 
	{ local_kernel_ce0 sc_out sc_logic 1 signal 2 } 
	{ local_kernel_we0 sc_out sc_logic 1 signal 2 } 
	{ local_kernel_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_kernel_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "local_kernel", "role": "address0" }} , 
 	{ "name": "local_kernel_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_kernel", "role": "ce0" }} , 
 	{ "name": "local_kernel_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_kernel", "role": "we0" }} , 
 	{ "name": "local_kernel_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "local_kernel", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	local_kernel { ap_memory {  { local_kernel_address0 mem_address 1 4 }  { local_kernel_ce0 mem_ce 1 1 }  { local_kernel_we0 mem_we 1 1 }  { local_kernel_d0 mem_din 1 16 } } }
}
